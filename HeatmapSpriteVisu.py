...
class SpriteVisu:
    ...
    def add_contact_to_list(self, chrom1, start1, chrom2, start2, inc1, inc2):
        """
        ...
        Args:
            ...
            inc1 (int): Increment value for the first chromosome's contacts.
            inc2 (int): Increment value for the second chromosome's contacts.
        """
                ...
                for chrom, bin_set in bins.items():
                    ...
                    if inc1 > 1:
                        for start1, start2 in combinations(bin_set, 2):
                            ...
                            self.add_contact_to_list(chrom, start1, chrom, start2, reads_len, inc2)
                        ...
                        for j in range(i + 1, len(chrom_list)):
                            ...
                            for start1 in bin_set1:
                                for start2 in bin_set2:
                                    self.add_contact_to_list(chrom1, start1, chrom2, start2, reads_len, inc2)
